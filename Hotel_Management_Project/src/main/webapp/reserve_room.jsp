...
<head>
<meta charset="UTF-8">
<title>StarOne Hotel - Reserve Room</title>
<style>
/* Basic Reset */
* {
    margin: 0;
...
<form action="reservedatabase.jsp">
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="number" placeholder="Enter Room Number" name="roomnumber" required></td>
        </tr>
        <tr>
            <td>Enter Aadhar Number:</td>
            <td><input type="number" placeholder="Enter Aadhar Number" name="aadhar" required></td>
        </tr>
        <tr>
            <td>Check In Date:</td>
